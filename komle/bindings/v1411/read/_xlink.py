# komle/bindings/v1411/read/_xlink.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:b43cd366527ddb6a0e58594876e07421e0148f30
# Generated 2020-05-05 12:27:35.394977 by PyXB version 1.2.6 using Python 3.8.2.final.0
...
class hrefType (pyxb.binding.datatypes.anyURI):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 44, 1)
    _Documentation = None
...
class roleType (pyxb.binding.datatypes.anyURI):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 50, 1)
    _Documentation = None
...
class arcroleType (pyxb.binding.datatypes.anyURI):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 58, 1)
    _Documentation = None
...
class titleAttrType (pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 66, 1)
    _Documentation = None
...
class labelType (pyxb.binding.datatypes.NCName):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 95, 1)
    _Documentation = None
...
class fromType (pyxb.binding.datatypes.NCName):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 101, 1)
    _Documentation = None
...
class toType (pyxb.binding.datatypes.NCName):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 107, 1)
    _Documentation = None
...
class extended (pyxb.binding.basis.complexTypeDefinition):
   ...
   """
    ...
    __title = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'title'), 'title', '__httpwww_w3_org1999xlink_extended_httpwww_w3_org1999xlinktitle', True, pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 167, 1), )
    ...
    __resource = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'resource'), 'resource', '__httpwww_w3_org1999xlink_extended_httpwww_w3_org1999xlinkresource', True, pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 193, 1), )
    ...
    __locator = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'locator'), 'locator', '__httpwww_w3_org1999xlink_extended_httpwww_w3_org1999xlinklocator', True, pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 213, 1), )
    ...
    __arc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'arc'), 'arc', '__httpwww_w3_org1999xlink_extended_httpwww_w3_org1999xlinkarc', True, pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 241, 1), )
...
class titleEltType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __lang._UseLocation = pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 171, 2)
...
class locatorType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.w3.org/1999/xlink}title uses Python identifier title
    __title = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'title'), 'title', '__httpwww_w3_org1999xlink_locatorType_httpwww_w3_org1999xlinktitle', True, pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 167, 1), )
...
class arcType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.w3.org/1999/xlink}title uses Python identifier title
    __title = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'title'), 'title', '__httpwww_w3_org1999xlink_arcType_httpwww_w3_org1999xlinktitle', True, pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 167, 1), )
...
title = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'title'), titleEltType, abstract=pyxb.binding.datatypes.boolean(1), location=pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 167, 1))
Namespace.addCategoryObject('elementBinding', title.name().localName(), title)

resource = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'resource'), resourceType, abstract=pyxb.binding.datatypes.boolean(1), location=pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 193, 1))
Namespace.addCategoryObject('elementBinding', resource.name().localName(), resource)

locator = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'locator'), locatorType, abstract=pyxb.binding.datatypes.boolean(1), location=pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 213, 1))
Namespace.addCategoryObject('elementBinding', locator.name().localName(), locator)

arc = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'arc'), arcType, abstract=pyxb.binding.datatypes.boolean(1), location=pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 241, 1))
...
def _BuildAutomaton ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 123, 3))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.WildcardUse(pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=pyxb.binding.content.Wildcard.NC_any), pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 123, 3))
...
extended._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'title'), titleEltType, abstract=pyxb.binding.datatypes.boolean(1), scope=extended, location=pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 167, 1)))

extended._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'resource'), resourceType, abstract=pyxb.binding.datatypes.boolean(1), scope=extended, location=pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 193, 1)))

extended._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'locator'), locatorType, abstract=pyxb.binding.datatypes.boolean(1), scope=extended, location=pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 213, 1)))
...
def _BuildAutomaton_ ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 163, 2))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(extended._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'title')), pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 146, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(extended._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'resource')), pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 147, 4))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(extended._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'locator')), pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 148, 4))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(extended._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'arc')), pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 149, 4))
...
def _BuildAutomaton_2 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 184, 3))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.WildcardUse(pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=pyxb.binding.content.Wildcard.NC_any), pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 184, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_3 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 204, 3))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.WildcardUse(pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=pyxb.binding.content.Wildcard.NC_any), pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 204, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_4 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 232, 3))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(locatorType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'title')), pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 232, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_5 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 261, 3))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(arcType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'title')), pyxb.utils.utility.Location('http://www.w3.org/1999/xlink.xsd', 261, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
