...
class STD_ANON (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('http://w3.energistics.org/energyML/data/common/v2.1/xsd_schemas/xlink/1.0.0/xlinks.xsd', 58, 6)
    _Documentation = None
...
class STD_ANON_ (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('http://w3.energistics.org/energyML/data/common/v2.1/xsd_schemas/xlink/1.0.0/xlinks.xsd', 85, 6)
    _Documentation = None
